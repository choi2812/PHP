		...
		<fieldset>
			<legend><strong>パスワード変更フォーム</strong></legend>
				...
				<table border="1" >
					<tr>
						<th>パスワード【必須】</th> 
						<td><input type="text"  size="35"name="yourname"><p style="color:blue; font-size:15px">登録メールアドレス使用できません。<br>半角英数字(英数まぜ)で６桁以上30桁以内</p></td>    
					</tr>
					<tr>
						<th>パスワードもう一度入力【必須】</th>
						<td><input type="text"size="35"  name="yourname"><p style="color:blue; font-size:15px">確認のためもう一度入力してください。</p></td> 
					</tr>
				</table>
