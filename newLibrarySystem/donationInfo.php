...
<div id="container">
	<div id="main">
		<h2>資料寄贈案内</h2>
		<h3> 寄贈はなぜ必要なのか?</h3>
			<p> 購入で入手できない資料、非売品資料収集<br/>個人所蔵の蔵書のうち有用な資料を発掘して既存の蔵書補強</p>
	
		<h3>&lt; 寄贈の流れ  &gt;</h3>
			<p><img	src = "img/donationInfo.png"  width="1200" height="110" alt="紅葉風景//에러 메세지"></p>
		
		<h3>どんな資料を寄贈を受けるのか?</h3>
		<ul>
			<li>未所蔵資料として学校のカリキュラム(curriculum)と大学構成員(先生や学生)の研究を支援する資料</li>
			<li>私たちの学校と関連された資料(当学校で発刊した資料や関連出版物)</li>
			<li>本校の先生や学界著名な学者の所蔵資料</li>
		</ul>
		<fieldset>
			<legend><strong>資料寄贈、関連の問い合わせ</strong></legend>
				<p>日本電子専門学校寄贈担当者</p>
