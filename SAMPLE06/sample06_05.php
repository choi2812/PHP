...
<?php
	...
	$sql = $dbh ->prepare('select MakerID,MakerName,MakerURL from "JYNET\\14jy0123".Maker where MakerID >= :id1 and MakerID <=:id2');
	$sql->bindValue(":id1", $strid,PDO::PARAM_STR);
	$sql->bindValue(":id2", $endid,PDO::PARAM_STR);
